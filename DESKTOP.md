...
| Pasek górny | **Pasek narzędzi jak w Todoist na Macu**: światła okna w jednej linii, ▯ menu boczne (z kropką, gdy są zaległe), ‹ › historia widoków, po prawej ✦ **Asystent tygodnia**, ☰ sortowanie i ⋯ menu (Sortowanie, Skanuj kartkę, Czas wolny, Kopiuj plan dnia; w projekcie: ulubione, Dodaj sekcję, Duplikuj, Archiwizuj, Usuń; w etykiecie: ulubione, Usuń). Przełącznik **obszaru** jest na górze menu bocznego. Tytuł widoku („Dziś" + liczba zadań i data) duży, wyrównany do lewej. |
